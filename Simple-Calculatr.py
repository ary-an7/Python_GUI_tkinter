...
label = Label(window, textvariable=equation_label, font=('Roboto',20,'bold'), bg="white",fg="green", width=27, height=4)
label.pack()
...
clear = Button(window, text='clear', height=2, width=30, font=35,padx=83,
                 command=clear)
clear.pack()
